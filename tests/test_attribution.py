...
def test_capability_registry_tracks_current_and_planned_sources():
    ...
    assert registry.implemented_sources == ("manual", "files")
    ...
    assert "PrimeObserverSource" in registry.planned_sources
    assert "CoreSignalSource" in registry.planned_sources
